...
public class TQChestItem {
    ...
    static {
        // tqit
        itBaseNameMap.put("^m_.+\\.dbr$",
                          0x2B); // m_e_arachnos.dbr
        itBaseNameMap.put("^egyptslavehat.*\\.dbr$",
                          0x2C); // egyptslavehat.dbr
        itBaseNameMap.put("^femalenpchair.*\\.dbr$",
                          0x2E); // femalenpchair01.dbr
        itBaseNameMap.put("^um_.+\\.dbr$",
                          0x32); // um_e_orpheusgarland.dbr
        itBaseNameMap.put("^usm_.+\\.dbr$",
                          0x36); // usm_e_raimentofthestorm.dbr
        itBaseNameMap.put("^u_.+_.+\\.dbr$",
                          0x36); // u_e_001.dbr
        itBaseNameMap.put("^us_.+\\.dbr$",
                          0x37); // us_l_001.dbr
        itBaseNameMap.put("^z_santa.*\\.dbr$",
                          0x38); // z_santa01.dbr
        itBaseNameMap.put("^z_france.*\\.dbr$",
                          0x39); // z_france01.dbr
        itBaseNameMap.put("^z_germany.*\\.dbr$",
                          0x3A); // z_germany01.dbr
        itBaseNameMap.put("^c\\d*_.+\\.dbr$",
                          0x3B); // c01_shield01.dbr
        itBaseNameMap.put("^mi_.+\\.dbr$",
                          0x3C); // mi_n_formicid.dbr
        itBaseNameMap.put("^u_[^_]+\\.dbr$",
                          0x40); // u_shield03prtdeco.dbr
        // tq
        baseNameMap.put("^c\\d*_.+\\.dbr$",
                        0x2D); // c01_shield01.dbr
        baseNameMap.put("^mi_e_.+\\.dbr$",
                        0x2D); // mi_e_formicid.dbr
        baseNameMap.put("^mi_l_.+\\.dbr$",
                        0x2E); // mi_l_formicid.dbr
        baseNameMap.put("^mi_n_.+\\.dbr$",
                        0x2D); // mi_n_formicid.dbr
        baseNameMap.put("^us_e_.+\\.dbr$",
                        0x32); // us_e_001.dbr
        baseNameMap.put("^us_l_.+\\.dbr$",
                        0x38); // us_l_001.dbr
        baseNameMap.put("^us_n_.+\\.dbr$",
                        0x37); // us_n_001.dbr
        
        baseNameMap.put("^m_.+\\.dbr$",
                        0x2B); // m_e_arachnos.dbr
        baseNameMap.put("^egyptslavehat.*\\.dbr$",
                        0x2C); // egyptslavehat.dbr
        baseNameMap.put("^femalenpchair.*\\.dbr$",
                        0x2E); // femalenpchair01.dbr
        baseNameMap.put("^um_.+\\.dbr$",
                        0x32); // um_e_orpheusgarland.dbr
        baseNameMap.put("^usm_.+\\.dbr$",
                        0x36); // usm_e_raimentofthestorm.dbr
        baseNameMap.put("^u_.+_.+\\.dbr$",
                        0x33); // u_e_001.dbr
        baseNameMap.put("^z_santa.*\\.dbr$",
                        0x38); // z_santa01.dbr
        baseNameMap.put("^z_france.*\\.dbr$",
                        0x39); // z_france01.dbr
        baseNameMap.put("^z_germany.*\\.dbr$",
                        0x3A); // z_germany01.dbr
        baseNameMap.put("^u_[^_]+\\.dbr$",
                        0x40); // u_shield03prtdeco.dbr
    }
     ...
     * @param y2
     */
    public void setPosition(Integer x1,
                            Integer x2,
                            Integer y1,
                            Integer y2) {
        //
    ...
    public void setDbrFile(String dbrFile) {
        ...
        if (this.base[0].intValue() == 0) {
            throw new IllegalArgumentException("ERROR:{" +
                                               fileName +
                                               "} is an unexpected item file name.");
        }
    }
